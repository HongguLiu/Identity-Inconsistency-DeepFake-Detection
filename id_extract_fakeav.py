...
f = open('/nas/home/hliu/Datasets/DeepfakeTIMIT/anomaly_frames.txt', 'a')

# root = "/nas/home/hliu/Datasets/FF++/Origin/"
# root = "/nas/home/hliu/Datasets/FakeAVCeleb_v1.2/FakeVideo-RealAudio/"
root = "/nas/home/hliu/Datasets/DeepfakeTIMIT/images/lower_quality/"
...
for vid in os.listdir(root):
    img_path = os.path.join(root, vid)
