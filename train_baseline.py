...
from model.base_model import LSTM_model, get_model
...
def train_epoch(epoch, num_epochs, data_loader, model_id, model_lstm, criterion, optimizer, log_path=None):
    ...
    model_id.train() #Identity_model for train baseline
    model_lstm.train()
    losses = AverageMeter()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default='/nas/home/hliu/insightface/model_zoo/arcface_torch/ms1mv3_arcface_r50_fp16/backbone.pth', help='Arcface pretrained weight')
